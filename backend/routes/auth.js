...
router.post('/deploy', async (req, res) => {
  ...
  exec(`cd "${projectDir}" && git fetch origin && git clean -fd && git reset --hard origin/main && node backend/scripts/migrate.js && echo PULLED`, { timeout: 120000 }, (err, stdout, stderr) => {
